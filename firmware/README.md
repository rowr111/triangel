...
The ear chip sends mel data to the eye chip over UART at ~30 fps. The wire frame format (50 bytes) is defined in [`shared/`](shared/) (`triangel-shared` crate):

| Offset | Size | Content |
|---|---|---|
| 0x00 | 1 byte | Sync byte `0xAA` |
| 0x01–0x30 | 48 bytes | 24 × u16 little-endian mel bands |
